...
test("alpha > 1", () => expect(CM("HsLa( 50.0 20 30 / 1.1 )").stringHSL()).toBe("hsla(50, 20%, 30%, 1)"));
test("alpha = 0", () => expect(CM("HsLa( 50.0 20 30 / 0 )").stringHSL()).toBe("hsla(50, 20%, 30%, 0)"));
test("alpha < 0", () => expect(CM("HsLa( 50.0 20 30 / -0.1 )").stringHSL()).toBe("hsla(0, 0%, 0%, 1)"));
