...
test("alpha > 1", () => expect(CM("lcha( 50.0 46 108 / 1.1 )").stringRGB()).toBe("rgba(112, 125, 37, 1)"));
test("alpha = 0", () => expect(CM("lcha( 50.0 46 108 / 0 )").stringRGB()).toBe("rgba(112, 125, 37, 0)"));
test("alpha < 0", () => expect(CM("lcha( 50.0 46 108 / -0.1 )").stringRGB()).toBe("rgba(0, 0, 0, 1)"));
