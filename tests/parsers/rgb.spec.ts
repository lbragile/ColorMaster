...
test("alpha > 1", () => expect(CM("rgba( 50.0 20 30 / 1.1 )").stringRGB()).toBe("rgba(50, 20, 30, 1)"));
test("alpha = 0", () => expect(CM("rgba( 50.0 20 30 / 0 )").stringRGB()).toBe("rgba(50, 20, 30, 0)"));
test("alpha < 0", () => expect(CM("rgba( 50.0 20 30 / -0.1 )").stringRGB()).toBe("rgba(0, 0, 0, 1)"));
