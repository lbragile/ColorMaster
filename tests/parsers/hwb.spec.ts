...
test("alpha > 1", () => expect(CM("hwba( 180 20 30 / 1.1 )").stringRGB()).toBe("rgba(51, 179, 179, 1)"));
test("alpha = 0", () => expect(CM("hwba( 180 20 30 / 0 )").stringRGB()).toBe("rgba(51, 179, 179, 0)"));
test("alpha < 0", () => expect(CM("hwba( 180 20 30 / -0.1 )").stringRGB()).toBe("rgba(0, 0, 0, 1)"));
